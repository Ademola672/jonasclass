...
for (const [i, scorer] of goalDetails) {
...
for (const [bey, value] of gameEvents) {
  // console.log(bey, value);
  const half = bey <= 45 ? "FIRST" : "SECOND";
  console.log(`[${half} HALF] ${bey}: ${value}`);
  // bey <= 45
  //   ? console.log(`[FIRST HALF] ${bey}: ${value}`)
  //   : console.log(`[SECOND HALF] ${bey}: ${value}`);
}
*/
////////////////////////////////////////////////////////////////////////////////////////
//4
...
// const conversion = function (underScore) {
//   const underScore = "";
//   const underScoreLower = "".toLowerCase();
// };

button.getEv("clicked", function (underScore) {
  const underScoreLower = underScore.toLowerCase().delete("_");
  console.log(underScoreLower);
});

conversion(""); //underscore_case
conversion(""); //first_name
conversion(""); //Some_Variable
conversion(""); //calculate_AGE
