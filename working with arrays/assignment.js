...
// const flatObject = dogs.flat(3);
// console.log(flatObject);

// console.log(currentDog);

// const dogFood = dogs.flatMap((dogFood) => dogFood.curFood);
// console.log(dogFood);

// const dogWeight = dogs.flatMap((dogWeight) => dogWeight.weight);
...
// console.log(
//   `${ownersEatTooMuch[0]} and ${ownersEatTooMuch[1]} and ${ownersEatTooMuch[2]}'s dogs eat too much! and ${ownersEatTooLittle[0]} and ${ownersEatTooLittle[1]} and ${ownersEatTooLittle[2]}'s dogs eat too little!`
// );
...
//7
// const dogsOkay = dogs.slice().map((dog) => dog.curFood === okayFood());
